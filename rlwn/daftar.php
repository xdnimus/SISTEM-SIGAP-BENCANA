 ...
 <body class="min-h-screen flex flex-col md:flex-row">
  ...
  <div class="md:w-1/2 flex flex-col justify-center px-8 py-16 bg-white">
   <form action="#" method="POST" class="max-w-sm w-full mx-auto" novalidate>
    <h2 class="text-[#0c2340] font-semibold text-lg mb-1">Register</h2>
    <p class="text-xs mb-6 text-[#0c2340]">Create your account to report and assist in disaster management</p>

    <label for="fullname" class="block text-xs mb-1 text-[#0c2340]">
     Full Name <span class="text-red-600">*</span>
    </label>
    <input id="fullname" name="fullname" type="text" placeholder="Full Name" required
     class="w-full border border-gray-300 rounded px-3 py-2 text-xs text-gray-700 placeholder-gray-400 mb-4 focus:outline-none focus:ring-1 focus:ring-blue-600"/>
    ...
    <label for="email" class="block text-xs mb-1 text-[#0c2340]">
    ...
    <div class="relative mb-4">
     ...
     <input id="password" name="password" type="password" placeholder="Password" required
      class="w-full border border-gray-300 rounded pl-9 px-3 py-2 text-xs text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-blue-600"/>
    ...
    <div class="flex justify-between items-center mb-6 text-xs text-[#0c2340]">
     <label class="flex items-center space-x-2">
      <input type="checkbox" class="w-4 h-4 border border-gray-300 rounded" required/>
      <span>I agree to the <a href="#" class="text-blue-700 hover:underline">Terms and Conditions</a></span>
     </label>
    </div>
